 ...
 *
 * The Buseiness Hours Widget Boilerplate is an organized, maintainable boilerplate for our made theme.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent_Biz_Hours
 * @author    Tony <tony_possamai@hotmail.com>
 * @license   GPL-2.0+
...
class Inhabitent_Biz_Hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			'Inhabitent_Biz_Hours',
			array(
				'classname'  => $this->get_widget_slug().'-class',
				'description' => "Add the store's busines hours."
			)
		);
...
add_action( 'widgets_init', function(){
     register_widget( 'Inhabitent_Biz_Hours' );
});
